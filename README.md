...
- [S1 | Programmation : Workshop](#s1--programmation--workshop)
  - [Table des Matières](#table-des-matières)
  - [Exercice 1 : Ne garder que le vert](#exercice-1--ne-garder-que-le-vert)
    - [Technique :](#technique-)
    - [Image de base :](#image-de-base-)
    - [Résultat :](#résultat-)
  - [Exercice 2 : Échanger les canaux](#exercice-2--échanger-les-canaux)
    - [Technique :](#technique--1)
    - [Image de base :](#image-de-base--1)
    - [Résultat :](#résultat--1)
  - [Exercice 3 : Noir \& Blanc](#exercice-3--noir--blanc)
    - [Technique :](#technique--2)
    - [Image de base :](#image-de-base--2)
    - [Résultat :](#résultat--2)
  - [Exercice 4 : Négatif](#exercice-4--négatif)
    - [Technique :](#technique--3)
    - [Image de base :](#image-de-base--3)
    - [Résultat :](#résultat--3)
  ...
  - [Exercice 6 : Miroir](#exercice-6--miroir)
    ...
    - [ATTENTION !!!](#attention-)
    - [Image de base :](#image-de-base--4)
    - [Erreur :](#erreur-)
    - [Résultat :](#résultat--5)
  - [Exercice 7 : Image bruitée](#exercice-7--image-bruitée)
    - [Technique :](#technique--6)
    - [Image de base :](#image-de-base--5)
    - [Résultat :](#résultat--6)
  - [Exercice 8 : Rotation à 90°](#exercice-8--rotation-à-90)
    - [Technique :](#technique--7)
    - [ATTENTION :](#attention--1)
    - [Image de base :](#image-de-base--6)
    - [Résultat :](#résultat--7)
  - [Exercice 9 : RGB Split](#exercice-9--rgb-split)
    - [Technique :](#technique--8)
    - [ATTENTION :](#attention--2)
    - [Image de base :](#image-de-base--7)
    - [Résultat :](#résultat--8)
  - [Exercice 10 : Luminosité](#exercice-10--luminosité)
    - [Technique :](#technique--9)
    - [Image de base :](#image-de-base--8)
    - [Résultat (avec une puissance de 2) :](#résultat-avec-une-puissance-de-2-)
  - [Exercice 11 : Disque](#exercice-11--disque)
    - [Technique :](#technique--10)
    - [Résultat :](#résultat--9)
  - [Exercice 12 : Cercle](#exercice-12--cercle)
    - [Technique :](#technique--11)
    - [Résultat :](#résultat--10)
  - [Exercice 13 : Rosace](#exercice-13--rosace)
    - [Technique :](#technique--12)
    - [Résultat :](#résultat--11)
  - [Exercice 14 : Mosaïque](#exercice-14--mosaïque)
    - [Technique :](#technique--13)
    - [Image de base :](#image-de-base--9)
    - [Résultat :](#résultat--12)
  - [Exercice 15 : Mosaïque miroir](#exercice-15--mosaïque-miroir)
    - [Technique :](#technique--14)
    - [Image de base :](#image-de-base--10)
    - [Résultat :](#résultat--13)
  - [Exercice 16 : Glitch](#exercice-16--glitch)
    - [Technique :](#technique--15)
    - [Image de base :](#image-de-base--11)
    - [Résultat :](#résultat--14)
  - [Exercice 17 : Fractale de Mandelbrot](#exercice-17--fractale-de-mandelbrot)
    - [Technique :](#technique--16)
    - [ATTENTION :](#attention--3)
    - [Résultat :](#résultat--15)
  - [Exercice 18 : Vortex](#exercice-18--vortex)
    - [Technique :](#technique--17)
    - [ATTENTION :](#attention--4)
    - [Image de base :](#image-de-base--12)
    - [Erreur :](#erreur--1)
    - [Résultat :](#résultat--16)
  - [Exercice 19 : Tramage](#exercice-19--tramage)
    - [Technique :](#technique--18)
    - [Image de base :](#image-de-base--13)
    - [Résultat :](#résultat--17)
  - [Exercice 20 : Normalisation de l'Histogramme](#exercice-20--normalisation-de-lhistogramme)
    - [Technique :](#technique--19)
    - [ATTENTION :](#attention--5)
    - [Image de base :](#image-de-base--14)
    - [Résultat :](#résultat--18)
  - [Exercice 21 : Convolutions](#exercice-21--convolutions)
    - [Technique :](#technique--20)
    - [ATTENTION :](#attention--6)
    - [Image de base :](#image-de-base--15)
    - [Résultat :](#résultat--19)
...
L'idée est de déterminer la luminance de chaque pixel. On l'obtient en faisant la moyenne des couleurs de chaque pixel. On remplace ensuite les valeurs RGB du pixel en question par la valeur obtenue.
...
Ici, l'idée est, pour chaque canal R, G et B de chaque pixel, de soustraire à 1.0 (la valeur max qu'une couleur peut avoir) la valeur RGB du pixel en question.
...
On effectue cet exercice à partir d'une image entièrement noire. L'idée va être de parcourir chaque pixel de l'image noire et de diviser la valeur x du pixel par la largeur totale de l'image. Le résultat obtenu sera attribué à chaque canal RGB du pixel. On peut remarquer que le résultat obtenu sera en nuances de gris étant donné que chaque canal RGB aura la même valeur pour chaque pixel. 
...
Ici, l'idée est de sélectionner des coordonnées aléatoires x et y sur notre image. Cela va nous permettre de sélectionner des pixels de manière aléatoire. Il suffit ensuite de sélectionner des valeurs aléatoires, comprises entre 0.0 et 1.0, pour les canaux RGB de chaque pixel sélectionné.
...
Cette technique nécessite encore une fois l'utilisation d'une seconde image. Cependant, notre logo possède une hauteur plus grande que sa largeur. Pour effectuer une rotation de 90°, il est nécessaire d'inverser les valeurs de largeur et de hauteur de la seconde image. 
...
Le but principe cet exercice est de modifier une photo à très faible contraste pour en améliorer son rendu visuel. Pour ce faire, d’après l’énoncé, il nous faut déterminer le pixel le plus lumineux et le plus sombre. L’idée est ensuite de transformer tous les pixels pour que le pixel le plus sombre soit complètement noir tandis que le pixel le plus clair soit entièrement blanc. La meilleure option est de trouver une formule qui va s’appliquer de la même manière sur tous les pixels. Dans un premier temps, il nous faut trouver la luminance du pixel le plus lumineux (appelée luminance max) et la luminance du pixel le plus sombre de l'image (appelée luminance min). Ensuite, le but est d'appliquer sur chaque couleur RGB de chaque pixel la formule qu'on aura trouvée. Celle-ci équivaut à  : (la couleur RGB du pixel - la luminance minimale) / (luminance max - luminance min)

### ATTENTION :

On pourrait être tenté d'utiliser deux formules, l'une pour rendre le pixel le plus sombre noir, l'autre pour rendre le pixel le plus lumineux blanc. Le problème est, qu'en procédant ainsi, on obtient des pixels très sombres et des pixels très lumineux, avec aucun entre-deux.
...
La convolution est un procédé qui vise à implémenter divers effets. Dans le cas de cet exercice, le but est de créer un effet de flou. Pour cela, il faut faire la moyenne des couleurs Rouges, Vertes et Bleues des pixels autour d'un pixel donné. Les valeurs trouvées seront ensuite attribuées aux canaux RGB du pixel en question. Plus l'opération engagera un nombre important de pixels, plus l'effet de flou sera dense. Le programme convolution parcours tous les pixels d'une image. Il fait la moyenne des couleurs RGB des pixels autour de chaque pixel. Il entre ensuite les valeurs obtenues dans les canaux du pixel en question. Il procède ainsi pour tous les pixels de l'image.

### ATTENTION :

Dans certains cas, concernant le champ de pixels choisi, il se peut que certains pixels soient en dehors des limites de l'image. On peut choisir de ne pas les prendre en compte dans le calcul de la moyenne. Cela fonctionne, mais l'effet de flou sur les pixels concernés n'est pas optimal. La meilleure solution est de faire comme s'il s'agissait de pixels noirs.
